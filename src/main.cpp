...
uint256 hashGenesisBlock("0x000000001a8562ea3ee5d64dc0d084920289f59e139d5d389c33a9fc8b239c29");
...
const string strMessageMagic = "DOGEBLACKCOIN Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000001a8562ea3ee5d64dc0d084920289f59e139d5d389c33a9fc8b239c29");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1412510293;
        block.nBits    = 486604799;
        block.nNonce   = 3192969534;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DOGEBLACKCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DOGEBLACKCOINMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DOGEBLACKCOINMiner started\n");
    ...
    try { loop {
        ...
        printf("Running DOGEBLACKCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("DOGEBLACKCOINMiner terminated\n");
        throw;
    }
}
